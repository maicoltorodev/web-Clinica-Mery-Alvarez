    ...
    <footer id="contacto" className="bg-foreground text-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold text-lg mb-4">Tratamientos</h3>
            <ul className="space-y-3">
              <li>
                <a href="#tratamientos" className="text-background/70 hover:text-primary transition-colors">
                  Faciales
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <a href="tel:+573163433000" className="text-background/70 hover:text-primary transition-colors">
                    +57 316 343 3000
                  </a>
                  <span className="text-background/60 text-sm">PBX: 604 322 9596</span>
                </div>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="border-t border-background/20 pt-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-xl font-semibold mb-2">Te ayudamos a rejuvenecer naturalmente</h3>
              <p className="text-background/70">Agenda tu cita de valoración en cualquiera de nuestras sedes. ¡Recuerda que TÚ eres tu mejor inversión!</p>
            </div>
